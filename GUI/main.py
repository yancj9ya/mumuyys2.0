...
class MyTabView(ctk.CTkTabview):
    def __init__(self, master, **kwargs):
        ctk.CTkTabview._outer_spacing = 0
        ...
        # add widgets on tabs
        self.maintab.pack(side="top", fill="x", pady=0, expand=True, anchor="n")

        self.tstab.pack(side="top", fill="x", pady=0, expand=True, anchor="n")

        self.logtab.pack(side="top", fill="both", pady=0, expand=True, anchor="n")

        self.pretasktab.pack(side="top", fill="both", pady=0, expand=True, anchor="n")

        self.log_area.pack(side="bottom", fill="both", pady=0, expand=True)

        self.settingtab.pack(side="top", fill="x", pady=0, expand=True, anchor="n")
