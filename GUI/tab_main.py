...
class MainTab(ctk.CTkFrame):
    ...
    def __init__(self, master=None, **kwargs):
        ...
        # combobox
        self.times = ctk.CTkComboBox(self, values=["10", "30", "100", "200", "300", "500", "999"], width=80, height=20, command=self.times_slider_value, justify="center", variable=self.times_value)
